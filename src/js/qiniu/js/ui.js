...
FileProgress.prototype.setChunkProgess = function(chunk_size) {
    ...
    var progressBarChunkTr = $('<div class="chunk-status-tr"><div></div></div>');
...
FileProgress.prototype.setComplete = function(up, info) {
    var td = this.fileProgressWrapper.find('div:eq(2) .progress');
    ...
    td.removeClass().next().next('.status').hide();
...
FileProgress.prototype.setCancelled = function(manual) {
    ...
    this.fileProgressWrapper.attr('class', progressContainer);
    this.fileProgressWrapper.find('div .progress .progress-bar-info').css('width', 0);
};
